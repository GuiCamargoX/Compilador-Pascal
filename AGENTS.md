...
- Compiler stages live in `Compiler/FrontEnd/` (`Scanner`, `Parser`, `SymbolTable`, tokens/symbols).
...
- Run from `Compiler/Tests` (required for current hardcoded input file lookup):
